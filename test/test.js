...
describe('Round', function() {
	it('is awaiting action if no players acted', function() {
	...
	it('is awaiting action if all but one player calls', function() {
		var player1 = new Player('player1'),
			player2 = new Player('player2'),
			round = new Round([player1, player2]);
	...
	it('is not awaiting action if all but one player folds', function() {
		var player1 = new Player('player1'),
			player2 = new Player('player2'),
			round = new Round([player1, player2]);
	...
	it('is not awaiting action if all bets equal', function() {
		var player1 = new Player('player1'),
			player2 = new Player('player2'),
			round = new Round([player1, player2]);
	...
	it('is game state transitions correct', function() {
		var player1 = new Player('player1'),
			player2 = new Player('player2'),
			round = new Round([player1, player2]);
